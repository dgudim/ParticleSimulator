...
public class Utils {
    ...
    static void makeAScreenShot(int recorderFrame) {
    ...
    static void makeAScreenShot(int recorderFrame, Pixmap pixmap) {
        PixmapIO.writePNG(Gdx.files.external("SlimeRender/pict" + recorderFrame + ".png"), pixmap);
    }
